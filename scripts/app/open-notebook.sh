...
start_openmaic() {
  ...
  if [ ! -f "$MAIC_DIR/.env" ]; then
    ...
    ollama_key="$(read_key OLLAMA_API_KEY)"; cline_key="$(read_key CLINE_API_KEY)"
    {
      ...
      echo "OPENROUTER_MODELS=gpt-5.5,gpt-5.6,gpt-6-astra,claude-haiku-4-5-20251001,claude-sonnet-5"
      ...
      echo "ANTHROPIC_MODELS=claude-haiku-4-5-20251001,claude-sonnet-5"
