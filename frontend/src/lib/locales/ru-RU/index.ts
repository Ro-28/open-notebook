...
export const ruRU = {
  ...
  advanced: {
    errorLog: "Недавние ошибки",
    errorLogDesc: "Предупреждения и ошибки API и фонового воркера, сохранённые на диск для последующей отладки (массовые загрузки, эмбеддинги, вызовы моделей).",
    errorLogEmpty: "Ошибок не зафиксировано.",
    errorLogTrace: "Показать детали",
    errorLogCleared: "Журнал ошибок очищен",
    errorLogCopied: "Журнал ошибок скопирован",
    errorLevelAll: "Все",
    errorLevelWarning: "Предупреждения",
    errorLevelError: "Ошибки",
  ...
  models: {
    limits: "Лимиты модели",
    limitsDesc: "Необязательно. Вблизи окна контекста происходит переключение на модель с большим контекстом; макс. токенов ограничивает вывод.",
    contextWindow: "Окно контекста (токены)",
    maxTokens: "Макс. токенов вывода",
    limitsSaved: "Лимиты сохранены",
    testAll: "Проверить все модели",
    testingAll: "Проверка…",
    testAllResults: "Результаты проверки",
    testAllSummary: "{{passed}} успешно · {{failed}} с ошибкой",
  ...
  learn: {
    chat: {
      ...
      intro: "Задайте любой вопрос по уроку. Учитель знает слайды и может заглянуть в ваш блокнот.",
      placeholder: "Вопрос по этому слайду…",
      send: "Отправить",
      error: "Учитель не смог ответить.",
      empty: "(нет ответа)",
      suggestExplain: "Объясни этот слайд простыми словами",
      suggestExample: "Приведи конкретный пример",
      suggestQuiz: "Проверь меня по этому",
    },
    ...
    player: {
      ...
      unsupportedScene: "Сцена типа {{type}} требует полного вида класса.",
      teacher: "Учитель",
      quizIntro: "Ответьте на вопросы, затем проверьте ответы.",
      noNarration: "Для этого слайда нет озвучки.",
      previous: "Назад",
      next: "Далее",
      play: "Воспроизвести",
      pause: "Пауза",
      ...
      score: "{{score}} / {{total}} верно",
    },
    liveRetrieval: "Искать в блокноте во время урока",
    liveRetrievalDesc: "Класс запрашивает детали из этого блокнота по мере необходимости — работает и для блокнотов больше промпта.",
    pageTitle: "Учиться",
    pageDesc: "Интерактивные ИИ-классы на основе ваших блокнотов: слайды, ИИ-учитель и тесты.",
    pageEmpty: "Классов пока нет. Выберите блокнот выше и создайте первый.",
    pickNotebook: "Выберите блокнот…",
    button: "Учиться",
    title: "Учиться",
    description: "Превратите этот блокнот в интерактивный ИИ-класс со слайдами, ИИ-учителем и тестом (на базе OpenMAIC).",
    checkingService: "Проверка сервиса обучения...",
    unavailable: "Сервис обучения не запущен",
    unavailableDesc: "OpenMAIC недоступен по адресу {{url}}. Запустите его через приложение Open Notebook или scripts/app/open-notebook.sh start.",
    requirementLabel: "На чём должен быть сделан акцент в уроке? (необязательно)",
    requirementPlaceholder: "напр. Объясни ключевые понятия для новичка в 5 слайдах и заверши тестом",
    materials: "Включаемые материалы",
    ...
    notReady: "Этот класс ещё не готов.",
    materialStats: "{{sources}} источников · {{insights}} инсайтов · {{notes}} заметок",
    generationStarted: "Создание класса запущено",
    generationStartedDesc: "Обычно это занимает одну-две минуты. Прогресс обновляется автоматически.",
    generationFailed: "Не удалось запустить создание класса",
