export const enUS = {
  ...
  advanced: {
    ...
    errorLogDesc: "Warnings and errors from the API and background worker, persisted to disk so you can debug later (bulk uploads, embeddings, model calls).",
    errorLogEmpty: "No errors recorded.",
    errorLogTrace: "Show details",
    errorLogCleared: "Error log cleared",
    errorLogCopied: "Error log copied",
    errorLevelAll: "All",
    errorLevelWarning: "Warnings",
  ...
  models: {
    limits: "Model limits",
    limitsDesc: "Optional. Context window switches to the large-context model near the limit; max tokens caps the output.",
    contextWindow: "Context window (tokens)",
    maxTokens: "Max output tokens",
    limitsSaved: "Model limits saved",
    testAll: "Test all models",
    testingAll: "Testing…",
    testAllResults: "Model test results",
  ...
  learn: {
    ...
    player: {
      ...
      unsupportedScene: "This {{type}} scene needs the full classroom view.",
      teacher: "Teacher",
      quizIntro: "Answer the questions, then check your answers.",
      noNarration: "No narration for this slide.",
      previous: "Previous",
      next: "Next",
      play: "Play",
      pause: "Pause",
    ...
    checkingService: "Checking the Learn service...",
    unavailable: "Learn service is not running",
    unavailableDesc: "OpenMAIC was not reachable at {{url}}. Start it with the Open Notebook app or scripts/app/open-notebook.sh start.",
    requirementLabel: "What should the lesson focus on? (optional)",
    requirementPlaceholder: "e.g. Explain the key concepts for a beginner in 5 slides and finish with a quiz",
    materials: "Materials to include",
    ...
    notReady: "This classroom is not ready yet.",
    materialStats: "{{sources}} sources · {{insights}} insights · {{notes}} notes",
    generationStarted: "Classroom generation started",
    generationStartedDesc: "This usually takes a minute or two. Progress updates automatically.",
    generationFailed: "Could not start classroom generation",
