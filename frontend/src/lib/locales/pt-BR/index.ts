...
export const ptBR = {
  ...
  advanced: {
    errorLog: "Erros recentes",
    errorLogDesc: "Avisos e erros da API e do worker em segundo plano, gravados em disco para depuração posterior (uploads em massa, embeddings, chamadas de modelo).",
    errorLogEmpty: "Nenhum erro registrado.",
    errorLogTrace: "Ver detalhes",
    errorLogCleared: "Registro de erros limpo",
    errorLogCopied: "Registro de erros copiado",
    errorLevelAll: "Todos",
    errorLevelWarning: "Avisos",
    errorLevelError: "Erros",
  ...
  models: {
    limits: "Limites do modelo",
    limitsDesc: "Opcional. A janela de contexto muda para o modelo de contexto grande perto do limite; máx. de tokens limita a saída.",
    contextWindow: "Janela de contexto (tokens)",
    maxTokens: "Máx. de tokens de saída",
    limitsSaved: "Limites salvos",
    testAll: "Testar todos os modelos",
    testingAll: "Testando…",
    testAllResults: "Resultados dos testes",
    testAllSummary: "{{passed}} ok · {{failed}} falhas",
  ...
  learn: {
    ...
    player: {
      ...
      unsupportedScene: "Esta cena do tipo {{type}} precisa da visão completa da sala.",
      teacher: "Professor",
      quizIntro: "Responda às perguntas e depois confira suas respostas.",
      noNarration: "Sem narração para este slide.",
      previous: "Anterior",
      next: "Próximo",
      play: "Reproduzir",
      pause: "Pausar",
      ...
      checkAnswers: "Conferir respostas",
      score: "{{score}} / {{total}} corretas",
    },
    ...
    checkingService: "Verificando o serviço de aprendizado...",
    unavailable: "O serviço de aprendizado não está em execução",
    unavailableDesc: "Não foi possível acessar o OpenMAIC em {{url}}. Inicie-o pelo app Open Notebook ou scripts/app/open-notebook.sh start.",
    requirementLabel: "No que a aula deve focar? (opcional)",
    requirementPlaceholder: "ex.: Explique os conceitos principais para um iniciante em 5 slides e termine com um quiz",
    materials: "Materiais a incluir",
    ...
    notReady: "Esta sala de aula ainda não está pronta.",
    materialStats: "{{sources}} fontes · {{insights}} insights · {{notes}} notas",
    generationStarted: "Geração da sala de aula iniciada",
    generationStartedDesc: "Normalmente leva um ou dois minutos. O progresso é atualizado automaticamente.",
    generationFailed: "Não foi possível iniciar a geração",
    deleted: "Sala de aula excluída",
    status: {
      pending: "Pendente",
      running: "Gerando",
      succeeded: "Pronta",
