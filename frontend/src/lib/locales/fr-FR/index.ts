...
export const frFR = {
  ...
  advanced: {
    errorLog: "Erreurs récentes",
    errorLogDesc: "Avertissements et erreurs de l'API et du worker, enregistrés sur disque pour déboguer plus tard (imports en masse, embeddings, appels de modèles).",
    errorLogEmpty: "Aucune erreur enregistrée.",
    errorLogTrace: "Afficher les détails",
    errorLogCleared: "Journal des erreurs effacé",
    errorLogCopied: "Journal des erreurs copié",
    errorLevelAll: "Tous",
    errorLevelWarning: "Avertissements",
    errorLevelError: "Erreurs",
  ...
  models: {
    limits: "Limites du modèle",
    limitsDesc: "Facultatif. La fenêtre de contexte bascule vers le modèle grand contexte près de la limite ; les tokens max plafonnent la sortie.",
    contextWindow: "Fenêtre de contexte (tokens)",
    maxTokens: "Tokens de sortie max",
    limitsSaved: "Limites enregistrées",
    testAll: "Tester tous les modèles",
    testingAll: "Test en cours…",
    testAllResults: "Résultats des tests",
    testAllSummary: "{{passed}} réussis · {{failed}} échoués",
  ...
  learn: {
    ...
    player: {
      ...
      unsupportedScene: "Cette scène {{type}} nécessite la vue classe complète.",
      teacher: "Professeur",
      quizIntro: "Répondez aux questions puis vérifiez vos réponses.",
      noNarration: "Pas de narration pour cette diapositive.",
      previous: "Précédent",
      next: "Suivant",
      play: "Lecture",
      pause: "Pause",
    ...
    checkingService: "Vérification du service d'apprentissage...",
    unavailable: "Le service d'apprentissage n'est pas démarré",
    unavailableDesc: "OpenMAIC est injoignable à {{url}}. Démarrez-le avec l'app Open Notebook ou scripts/app/open-notebook.sh start.",
    requirementLabel: "Sur quoi la leçon doit-elle se concentrer ? (facultatif)",
    requirementPlaceholder: "ex. Expliquer les concepts clés pour un débutant en 5 diapositives et terminer par un quiz",
    materials: "Matériaux à inclure",
    ...
    notReady: "Cette classe n'est pas encore prête.",
    materialStats: "{{sources}} sources · {{insights}} analyses · {{notes}} notes",
    generationStarted: "Génération de la classe lancée",
    generationStartedDesc: "Cela prend généralement une à deux minutes. La progression se met à jour automatiquement.",
    generationFailed: "Impossible de lancer la génération",
