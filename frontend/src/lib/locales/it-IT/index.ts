...
export const itIT = {
  ...
  advanced: {
    errorLog: "Errori recenti",
    errorLogDesc: "Avvisi ed errori dell'API e del worker in background, salvati su disco per il debug (caricamenti massivi, embedding, chiamate ai modelli).",
    errorLogEmpty: "Nessun errore registrato.",
    errorLogTrace: "Mostra dettagli",
    errorLogCleared: "Registro errori svuotato",
    errorLogCopied: "Registro errori copiato",
    errorLevelAll: "Tutti",
    errorLevelWarning: "Avvisi",
    errorLevelError: "Errori",
  ...
  models: {
    limits: "Limiti del modello",
    limitsDesc: "Facoltativo. Vicino alla finestra di contesto si passa al modello a contesto ampio; i token massimi limitano l'output.",
    contextWindow: "Finestra di contesto (token)",
    maxTokens: "Token di output massimi",
    limitsSaved: "Limiti salvati",
    testAll: "Testa tutti i modelli",
    testingAll: "Test in corso…",
    testAllResults: "Risultati dei test",
    testAllSummary: "{{passed}} riusciti · {{failed}} falliti",
  ...
  learn: {
    ...
    player: {
      ...
      unsupportedScene: "Questa scena {{type}} richiede la vista aula completa.",
      teacher: "Insegnante",
      quizIntro: "Rispondi alle domande, poi verifica le risposte.",
      noNarration: "Nessuna narrazione per questa slide.",
      previous: "Precedente",
      next: "Successivo",
      play: "Riproduci",
      pause: "Pausa",
    ...
    checkingService: "Verifica del servizio di apprendimento...",
    unavailable: "Il servizio di apprendimento non è attivo",
    unavailableDesc: "OpenMAIC non è raggiungibile su {{url}}. Avvialo con l'app Open Notebook o scripts/app/open-notebook.sh start.",
    requirementLabel: "Su cosa deve concentrarsi la lezione? (facoltativo)",
    requirementPlaceholder: "es. Spiega i concetti chiave a un principiante in 5 slide e concludi con un quiz",
    materials: "Materiali da includere",
    ...
    notReady: "Questa aula non è ancora pronta.",
    materialStats: "{{sources}} fonti · {{insights}} insight · {{notes}} note",
    generationStarted: "Generazione dell'aula avviata",
    generationStartedDesc: "Di solito richiede uno o due minuti. I progressi si aggiornano automaticamente.",
    generationFailed: "Impossibile avviare la generazione",
    deleted: "Aula eliminata",
    status: {
      pending: "In attesa",
      running: "Generazione",
      succeeded: "Pronta",
