...
export const zhTW = {
  ...
  advanced: {
    errorLog: "最近的錯誤",
    errorLogDesc: "來自 API 與背景工作的警告與錯誤，持久儲存到磁碟以便之後除錯（批次上傳、向量化、模型呼叫）。",
    errorLogEmpty: "尚無錯誤記錄。",
    errorLogTrace: "顯示詳細資料",
    errorLogCleared: "錯誤記錄已清除",
    errorLogCopied: "錯誤記錄已複製",
    errorLevelAll: "全部",
  ...
  models: {
    limits: "模型限制",
    limitsDesc: "選填。接近上下文視窗時切換到大上下文模型；最大令牌數限制輸出。",
    contextWindow: "上下文視窗（令牌）",
    maxTokens: "最大輸出令牌",
    limitsSaved: "模型限制已儲存",
    testAll: "測試全部模型",
    testingAll: "測試中…",
    testAllResults: "模型測試結果",
    testAllSummary: "{{passed}} 通過 · {{failed}} 失敗",
    embedding: "嵌入模型",
    tts: "文字轉語音",
    stt: "語音轉文字",
    apiKey: "API 密鑰",
  ...
  learn: {
    ...
    player: {
      ...
      modeFull: "完整課堂",
      loadFailed: "無法載入課堂內容。",
      unsupportedScene: "此 {{type}} 場景需要完整課堂檢視。",
      teacher: "老師",
      quizIntro: "回答問題，然後檢查答案。",
      noNarration: "此投影片沒有講解。",
      previous: "上一步",
      next: "下一步",
      play: "播放",
      pause: "暫停",
    ...
    checkingService: "正在檢查學習服務...",
    unavailable: "學習服務未執行",
    unavailableDesc: "無法連線至 {{url}} 上的 OpenMAIC。請透過 Open Notebook 應用程式或 scripts/app/open-notebook.sh start 啟動。",
    requirementLabel: "課程應著重什麼？（選填）",
    requirementPlaceholder: "例如：用 5 張投影片向初學者講解核心概念，並以測驗結束",
    materials: "包含的材料",
    includeSources: "來源內容",
    ...
    openInNewTab: "在新分頁開啟",
    notReady: "此課堂尚未就緒。",
    materialStats: "{{sources}} 個來源 · {{insights}} 則洞察 · {{notes}} 則筆記",
    generationStarted: "課堂產生已開始",
    generationStartedDesc: "通常需要一兩分鐘，進度會自動更新。",
    generationFailed: "無法開始產生課堂",
    deleted: "課堂已刪除",
    status: {
      pending: "等待中",
      running: "產生中",
