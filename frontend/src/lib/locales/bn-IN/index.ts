...
export const bnIN = {
  ...
  advanced: {
    errorLog: "সাম্প্রতিক ত্রুটি",
    errorLogDesc: "API ও ব্যাকগ্রাউন্ড ওয়ার্কারের সতর্কতা ও ত্রুটি ডিস্কে সংরক্ষিত থাকে যাতে পরে ডিবাগ করা যায় (বাল্ক আপলোড, এমবেডিং, মডেল কল)।",
    errorLogEmpty: "কোনো ত্রুটি রেকর্ড হয়নি।",
    errorLogTrace: "বিস্তারিত দেখুন",
    errorLogCleared: "ত্রুটি লগ মুছে ফেলা হয়েছে",
    errorLogCopied: "ত্রুটি লগ কপি হয়েছে",
    errorLevelAll: "সব",
    errorLevelWarning: "সতর্কতা",
    errorLevelError: "ত্রুটি",
    title: "উন্নত টুলস",
  ...
  models: {
    limits: "মডেলের সীমা",
    limitsDesc: "ঐচ্ছিক। কনটেক্সট উইন্ডোর কাছাকাছি হলে বড়-কনটেক্সট মডেলে যায়; সর্বোচ্চ টোকেন আউটপুট সীমিত করে।",
    contextWindow: "কনটেক্সট উইন্ডো (টোকেন)",
    maxTokens: "সর্বোচ্চ আউটপুট টোকেন",
    limitsSaved: "সীমা সংরক্ষিত",
    testAll: "সব মডেল পরীক্ষা করুন",
    testingAll: "পরীক্ষা চলছে…",
    testAllResults: "পরীক্ষার ফলাফল",
    testAllSummary: "{{passed}} সফল · {{failed}} ব্যর্থ",
  ...
  learn: {
    chat: {
      ...
      title: "শিক্ষককে জিজ্ঞাসা করুন",
      intro: "এই পাঠ সম্পর্কে যেকোনো প্রশ্ন করুন। শিক্ষক স্লাইডগুলো জানেন এবং আপনার নোটবুকে খুঁজে দেখতে পারেন।",
      placeholder: "এই স্লাইড সম্পর্কে জিজ্ঞাসা করুন…",
      send: "পাঠান",
      error: "শিক্ষক উত্তর দিতে পারেননি।",
      empty: "(কোনো উত্তর নেই)",
      suggestExplain: "এই স্লাইডটি সহজভাবে ব্যাখ্যা করুন",
      suggestExample: "একটি বাস্তব উদাহরণ দিন",
      suggestQuiz: "এ বিষয়ে আমাকে প্রশ্ন করুন",
    },
    learnThis: "এটি শিখুন",
    ...
    player: {
      ...
      unsupportedScene: "এই {{type}} দৃশ্যের জন্য সম্পূর্ণ ক্লাসরুম ভিউ প্রয়োজন।",
      teacher: "শিক্ষক",
      quizIntro: "প্রশ্নগুলোর উত্তর দিন, তারপর উত্তর যাচাই করুন।",
      noNarration: "এই স্লাইডের জন্য কোনো বর্ণনা নেই।",
      previous: "আগের",
      next: "পরের",
      play: "চালান",
      pause: "থামান",
      ...
      score: "{{score}} / {{total}} সঠিক",
    },
    liveRetrieval: "পড়ানোর সময় নোটবুকে খুঁজুন",
    liveRetrievalDesc: "ক্লাসরুম প্রয়োজনমতো এই নোটবুক থেকে বিস্তারিত খুঁজে নেয় — প্রম্পটের চেয়ে বড় নোটবুকেও কাজ করে।",
    pageTitle: "শিখুন",
    pageDesc: "আপনার নোটবুক থেকে তৈরি ইন্টারঅ্যাকটিভ AI ক্লাসরুম — স্লাইড, AI শিক্ষক ও কুইজ।",
    pageEmpty: "এখনও কোনো ক্লাসরুম নেই। উপরে একটি নোটবুক বেছে নিয়ে প্রথমটি তৈরি করুন।",
    pickNotebook: "একটি নোটবুক বেছে নিন…",
    button: "শিখুন",
    title: "শিখুন",
    description: "এই নোটবুককে স্লাইড, AI শিক্ষক ও কুইজসহ একটি ইন্টারঅ্যাকটিভ AI ক্লাসরুমে পরিণত করুন (OpenMAIC দ্বারা চালিত)।",
    checkingService: "লার্ন সার্ভিস পরীক্ষা করা হচ্ছে...",
    unavailable: "লার্ন সার্ভিস চালু নেই",
    unavailableDesc: "{{url}}-এ OpenMAIC-এর সাথে সংযোগ করা যায়নি। Open Notebook অ্যাপ বা scripts/app/open-notebook.sh start দিয়ে চালু করুন।",
    requirementLabel: "পাঠটি কীসের উপর জোর দেবে? (ঐচ্ছিক)",
    requirementPlaceholder: "যেমন: নতুনদের জন্য মূল ধারণাগুলো ৫টি স্লাইডে ব্যাখ্যা করুন এবং একটি কুইজ দিয়ে শেষ করুন",
    materials: "অন্তর্ভুক্ত উপকরণ",
    ...
    notReady: "এই ক্লাসরুমটি এখনও প্রস্তুত নয়।",
    materialStats: "{{sources}} সোর্স · {{insights}} ইনসাইট · {{notes}} নোট",
    generationStarted: "ক্লাসরুম তৈরি শুরু হয়েছে",
    generationStartedDesc: "সাধারণত এক-দুই মিনিট লাগে। অগ্রগতি স্বয়ংক্রিয়ভাবে আপডেট হয়।",
    generationFailed: "ক্লাসরুম তৈরি শুরু করা যায়নি",
    deleted: "ক্লাসরুম মুছে ফেলা হয়েছে",
    status: {
      pending: "অপেক্ষমাণ",
      running: "তৈরি হচ্ছে",
      succeeded: "প্রস্তুত",
