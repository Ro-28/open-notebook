...
export const esES = {
  ...
  advanced: {
    errorLog: "Errores recientes",
    errorLogDesc: "Avisos y errores de la API y del worker en segundo plano, guardados en disco para depurar más tarde (subidas masivas, embeddings, llamadas a modelos).",
    errorLogEmpty: "No hay errores registrados.",
    errorLogTrace: "Ver detalles",
    errorLogCleared: "Registro de errores borrado",
    errorLogCopied: "Registro de errores copiado",
    errorLevelAll: "Todos",
    errorLevelWarning: "Avisos",
    errorLevelError: "Errores",
  ...
  models: {
    limits: "Límites del modelo",
    limitsDesc: "Opcional. La ventana de contexto cambia al modelo de contexto grande cerca del límite; los tokens máximos limitan la salida.",
    contextWindow: "Ventana de contexto (tokens)",
    maxTokens: "Tokens máximos de salida",
    limitsSaved: "Límites guardados",
    testAll: "Probar todos los modelos",
    testingAll: "Probando…",
    testAllResults: "Resultados de las pruebas",
    testAllSummary: "{{passed}} correctos · {{failed}} fallidos",
  ...
  learn: {
    ...
    player: {
      ...
      unsupportedScene: "Esta escena de tipo {{type}} necesita la vista de aula completa.",
      teacher: "Profesor",
      quizIntro: "Responde a las preguntas y comprueba tus respuestas.",
      noNarration: "Esta diapositiva no tiene narración.",
      previous: "Anterior",
      next: "Siguiente",
      play: "Reproducir",
      pause: "Pausar",
    ...
    checkingService: "Comprobando el servicio de aprendizaje...",
    unavailable: "El servicio de aprendizaje no está activo",
    unavailableDesc: "No se pudo conectar con OpenMAIC en {{url}}. Inícialo con la app de Open Notebook o scripts/app/open-notebook.sh start.",
    requirementLabel: "¿En qué debe centrarse la lección? (opcional)",
    requirementPlaceholder: "p. ej. Explica los conceptos clave para un principiante en 5 diapositivas y termina con un cuestionario",
    materials: "Materiales a incluir",
    ...
    notReady: "Esta aula aún no está lista.",
    materialStats: "{{sources}} fuentes · {{insights}} análisis · {{notes}} notas",
    generationStarted: "Generación del aula iniciada",
    generationStartedDesc: "Suele tardar uno o dos minutos. El progreso se actualiza automáticamente.",
    generationFailed: "No se pudo iniciar la generación del aula",
