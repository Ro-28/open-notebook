...
export const zhCN = {
  ...
  advanced: {
    errorLog: "最近的错误",
    errorLogDesc: "来自 API 和后台任务的警告与错误，持久保存到磁盘以便稍后调试（批量上传、向量化、模型调用）。",
    errorLogEmpty: "暂无错误记录。",
    errorLogTrace: "显示详情",
    errorLogCleared: "错误日志已清空",
    errorLogCopied: "错误日志已复制",
    errorLevelAll: "全部",
  ...
  models: {
    limits: "模型限制",
    limitsDesc: "可选。接近上下文窗口时切换到大上下文模型；最大令牌数限制输出。",
    contextWindow: "上下文窗口（令牌）",
    maxTokens: "最大输出令牌",
    limitsSaved: "模型限制已保存",
    testAll: "测试全部模型",
    testingAll: "测试中…",
    testAllResults: "模型测试结果",
  ...
  learn: {
    ...
    player: {
      ...
      modeFull: "完整课堂",
      loadFailed: "无法加载课堂内容。",
      unsupportedScene: "此 {{type}} 场景需要完整课堂视图。",
      teacher: "老师",
      quizIntro: "回答问题，然后检查答案。",
      noNarration: "此幻灯片没有讲解。",
      previous: "上一步",
      next: "下一步",
      play: "播放",
      pause: "暂停",
    ...
    checkingService: "正在检查学习服务...",
    unavailable: "学习服务未运行",
    unavailableDesc: "无法连接 {{url}} 上的 OpenMAIC。请通过 Open Notebook 应用或 scripts/app/open-notebook.sh start 启动。",
    requirementLabel: "课程应侧重什么？（可选）",
    requirementPlaceholder: "例如：用 5 张幻灯片向初学者讲解核心概念，并以测验结束",
    materials: "包含的材料",
    includeSources: "来源内容",
    ...
    notReady: "此课堂尚未就绪。",
    materialStats: "{{sources}} 个来源 · {{insights}} 条洞察 · {{notes}} 条笔记",
    generationStarted: "课堂生成已开始",
    generationStartedDesc: "通常需要一两分钟，进度会自动更新。",
    generationFailed: "无法开始生成课堂",
    deleted: "课堂已删除",
    status: {
      pending: "等待中",
      running: "生成中",
