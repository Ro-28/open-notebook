...
export const jaJP = {
  ...
  advanced: {
    errorLog: "最近のエラー",
    errorLogDesc: "API とバックグラウンドワーカーの警告・エラーをディスクに保存し、後からデバッグできます（一括アップロード、埋め込み、モデル呼び出し）。",
    errorLogEmpty: "エラーは記録されていません。",
    errorLogTrace: "詳細を表示",
    errorLogCleared: "エラーログを消去しました",
    errorLogCopied: "エラーログをコピーしました",
    errorLevelAll: "すべて",
  ...
  models: {
    limits: "モデルの上限",
    limitsDesc: "任意。コンテキスト上限付近では大コンテキストモデルに切り替わり、最大トークンで出力を制限します。",
    contextWindow: "コンテキストウィンドウ（トークン）",
    maxTokens: "最大出力トークン",
    limitsSaved: "上限を保存しました",
    testAll: "すべてのモデルをテスト",
    testingAll: "テスト中…",
    testAllResults: "テスト結果",
    testAllSummary: "成功 {{passed}} · 失敗 {{failed}}",
  ...
  learn: {
    ...
    player: {
      ...
      unsupportedScene: "この {{type}} シーンにはフル教室ビューが必要です。",
      teacher: "先生",
      quizIntro: "問題に答えてから答え合わせをしてください。",
      noNarration: "このスライドにはナレーションがありません。",
      previous: "前へ",
      next: "次へ",
      play: "再生",
      pause: "一時停止",
    ...
    checkingService: "学習サービスを確認中...",
    unavailable: "学習サービスが起動していません",
    unavailableDesc: "{{url}} のOpenMAICに接続できません。Open Notebookアプリまたは scripts/app/open-notebook.sh start で起動してください。",
    requirementLabel: "授業の焦点（任意）",
    requirementPlaceholder: "例：初心者向けに重要な概念を5枚のスライドで説明し、最後にクイズを出す",
    materials: "含める資料",
    ...
    notReady: "この教室はまだ準備中です。",
    materialStats: "ソース {{sources}} · インサイト {{insights}} · ノート {{notes}}",
    generationStarted: "教室の生成を開始しました",
    generationStartedDesc: "通常1〜2分かかります。進捗は自動で更新されます。",
    generationFailed: "教室の生成を開始できませんでした",
    deleted: "教室を削除しました",
    status: {
      pending: "待機中",
      running: "生成中",
