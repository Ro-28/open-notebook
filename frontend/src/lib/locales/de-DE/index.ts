...
export const deDE = {
  ...
  advanced: {
    errorLog: "Letzte Fehler",
    errorLogDesc: "Warnungen und Fehler von API und Hintergrund-Worker, auf Platte gespeichert zum späteren Debuggen (Massen-Uploads, Embeddings, Modellaufrufe).",
    errorLogEmpty: "Keine Fehler aufgezeichnet.",
    errorLogTrace: "Details anzeigen",
    errorLogCleared: "Fehlerprotokoll geleert",
    errorLogCopied: "Fehlerprotokoll kopiert",
    errorLevelAll: "Alle",
    errorLevelWarning: "Warnungen",
    errorLevelError: "Fehler",
  ...
  models: {
    limits: "Modell-Limits",
    limitsDesc: "Optional. Nahe dem Kontextfenster wird auf das Large-Context-Modell gewechselt; Max-Tokens begrenzt die Ausgabe.",
    contextWindow: "Kontextfenster (Tokens)",
    maxTokens: "Max. Ausgabe-Tokens",
    limitsSaved: "Limits gespeichert",
    testAll: "Alle Modelle testen",
    testingAll: "Teste…",
    testAllResults: "Testergebnisse",
    testAllSummary: "{{passed}} bestanden · {{failed}} fehlgeschlagen",
  ...
  learn: {
    ...
    player: {
      ...
      unsupportedScene: "Diese {{type}}-Szene braucht die vollständige Klassenzimmer-Ansicht.",
      teacher: "Lehrer",
      quizIntro: "Beantworte die Fragen und prüfe dann deine Antworten.",
      noNarration: "Keine Erzählung für diese Folie.",
      previous: "Zurück",
      next: "Weiter",
      play: "Abspielen",
      pause: "Pause",
    ...
    checkingService: "Lern-Dienst wird geprüft...",
    unavailable: "Lern-Dienst läuft nicht",
    unavailableDesc: "OpenMAIC war unter {{url}} nicht erreichbar. Starte es mit der Open-Notebook-App oder scripts/app/open-notebook.sh start.",
    requirementLabel: "Worauf soll sich die Lektion konzentrieren? (optional)",
    requirementPlaceholder: "z. B. Erkläre die Kernkonzepte für Einsteiger in 5 Folien und schließe mit einem Quiz ab",
    materials: "Einzuschließende Materialien",
    ...
    open: "Klassenzimmer öffnen",
    openInNewTab: "In neuem Tab öffnen",
    notReady: "Dieses Klassenzimmer ist noch nicht fertig.",
    materialStats: "{{sources}} Quellen · {{insights}} Insights · {{notes}} Notizen",
    generationStarted: "Erzeugung gestartet",
    generationStartedDesc: "Das dauert meist ein bis zwei Minuten. Der Fortschritt wird automatisch aktualisiert.",
    generationFailed: "Erzeugung konnte nicht gestartet werden",
    deleted: "Klassenzimmer gelöscht",
    status: {
      pending: "Ausstehend",
